...
The [Green Algorithms](https://calculator.green-algorithms.org/) calculator is an online and publicly available tool estimating the environmental footprint of digital computations. It is developped by the [Lannelongue group](https://www.lannelongue-group.org/) from Cambridge University.
